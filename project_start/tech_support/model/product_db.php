...
/**/
function add_product(string $code, string $name, float $version, string $release_date) {//updated to strict typing
    global $db;
...
function update_product(string $code, string $name, float $version, string $release_date) {//updated to strict typing, still not called anywhere though
    global $db;
